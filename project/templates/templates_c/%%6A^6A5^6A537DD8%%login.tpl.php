<?php /* Smarty version 2.6.19, created on 2018-04-12 20:12:52
...
<body class="gray-bg">
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
        	<img src="images/logo.png" height="300" width="300"/><br/><br/><br/>
            <!-- start Login Page -->
            ...
            <p class="m-t"> <strong>Copyright</strong> Foresee &copy; 2018 </p>
        </div>
    </div>
</body>
