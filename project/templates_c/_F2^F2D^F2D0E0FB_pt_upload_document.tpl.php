<?php /* Smarty version 2.6.19, created on 2017-07-20 03:50:34
			...
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					<form id = "target" method="post" class="form-horizontal" action="pt_upload_document.php" enctype="multipart/form-data">
						<?php if (empty ( $this->_tpl_vars['PatientID'] )): ?>
						<div class="form-group">							
							<label class="col-sm-4 control-label">Patient</label>
							<div class="col-sm-8">		
								<select  id="patient_selector_upload" name = "patient_id" class="form-control doctor text-right" required="" style="width: 100%"></select>
							</div>							
						</div>					
						<?php endif; ?>
						<div class="form-group">
							<label class="col-sm-4 control-label">Visit</label>
							<div class="col-sm-8">
...
><?php echo $this->_tpl_vars['Type']['vName']; ?>
						...
						<div class="row">	
							...
							<div clas="col-lg-2">
								<button type="button" class="btn btn-w-m btn-danger pull-left" onclick="cancel()"><strong>Cancel</strong></button>
							</div>
						</div>
...
<?php echo $this->_tpl_vars['PatientID']; ?>
<?php echo '");
